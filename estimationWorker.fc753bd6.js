...
},{"@tensorflow/tfjs-core":"node_modules/@tensorflow/tfjs-core/dist/tf-core.esm.js","@tensorflow/tfjs-converter":"node_modules/@tensorflow/tfjs-converter/dist/tf-converter.esm.js"}],"workers/estimationWorker.js":[function(require,module,exports) {
"use strict";
...
async function estimate(video, state) {
  const predictions = await model.estimateHands(video, !state.flip);
  postMessage(['predictions', predictions]);
}

onmessage = function (event) {
  if (event.data[0] === 'loadModel') loadModel(event.data[1]);
  if (event.data[0] === 'estimate') estimate(event.data[1], event.data[2]); // worker.onmessage = resultReceiver;
  // worker.onerror = errorReceiver;
  // worker.postMessage(n - i);
};
},{"@tensorflow-models/handpose":"node_modules/@tensorflow-models/handpose/dist/handpose.esm.js"}]},{},["workers/estimationWorker.js"], null)
//# sourceMappingURL=/estimationWorker.fc753bd6.js.map