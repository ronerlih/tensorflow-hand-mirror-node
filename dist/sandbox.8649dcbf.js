...
},{"./fingers.js":"utils/fingers.js"}],"node_modules/validate.io-array/lib/index.js":[function(require,module,exports) {
'use strict';
...
},{}],"utils/findSimilar.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = findSimilar;

const similarity = require('compute-cosine-similarity');

const VPTreeFactory = require('vptree');

function findSimilar(currentUserPose, poseData) {
...
async function main() {
  ...
  drawToCanvas(inputCanvas, predictions); // find similar

  (0, _findSimilar.default)(currentPose, poseData);
}
